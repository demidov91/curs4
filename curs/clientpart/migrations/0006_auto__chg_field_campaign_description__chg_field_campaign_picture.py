...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'clientpart_campaign', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Campaign.picture'
        db.alter_column(u'clientpart_campaign', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Campaign.description'
        db.alter_column(u'clientpart_campaign', 'description', self.gf('django.db.models.fields.TextField')(max_length=1255))

        # Changing field 'Campaign.picture'
        db.alter_column(u'clientpart_campaign', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
