...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'clientpart_campaign', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Campaign.description'
        db.add_column(u'clientpart_campaign', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'clientpart_campaign', 'title')

        # Deleting field 'Campaign.description'
        db.delete_column(u'clientpart_campaign', 'description')
